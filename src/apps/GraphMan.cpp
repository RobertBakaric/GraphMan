...
cout <<"***************************************************************************************"<<"\n";
cout <<"                           GraphMan - Graph Manipulation tool                          "<<"\n";
cout <<"                                          by                                           "<<"\n";
cout <<"                                    Robert Bakaric                                     "<<"\n\n";
cout <<"CONTACT:                                                                               "<<"\n";
...
/* Construct Graph */
  ...
  int  x = garph.CreateVertex(); 
  int  y = garph.CreateVertex();

  cout << "CreateVertex:" <<  x << endl;
  cout << "CreateVertex:" <<  y << endl;
  ...
  cout << "RemoveVertex(67)\n";
  garph.RemoveVertex(67);

  cout << "\nTraversal:\n";
  garph.DepthFirstTrav(1,0,1);
  vector<int>a(garph.GetDepthVec());
  vector<int>b(garph.GetVerticesVec());
  cout << a << endl;
  cout << b << endl;
